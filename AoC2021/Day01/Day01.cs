...
namespace Day01
{
    class Program
    {
        ...
        private Program(string inputFile, bool part1)
        {
            ...
            if (part1)
            {
                var result1 = CountIncreasesWindow(inputValues, 1);
            ...
            {
                var result2 = CountIncreasesWindow(inputValues, 3);
        ...
        static void Parse(string[] lines)
        {
            ...
            inputValues = new int[count];
            var i = 0;
            foreach (var line in lines)
            {
                inputValues[i] = int.Parse(line);
                ++i;
            }
        }

        public static int CountIncreasesWindow(int[] values, int window)
        {
            int countIncreases = 0;
            var previous = values[0];
            var count = values.Length;
            for (var i = window; i < count; ++i)
            {
